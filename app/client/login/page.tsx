    ...
    <div className="min-h-screen bg-[#FAF8F5] dark:bg-[#0C0A09] text-foreground flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans select-none transition-colors duration-300">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground font-bold text-xs uppercase tracking-[0.2em] opacity-80">Client Command Portal</p>
        </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder="••••••••"
                  className="bg-background/50 dark:bg-white/[0.02] border-border dark:border-white/10 focus:border-[#EA580C] focus-visible:ring-[#EA580C] rounded-xl h-12 text-foreground placeholder:text-muted-foreground/50 font-medium pr-12 transition-all"
                  value={password}
